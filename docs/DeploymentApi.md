...
------------- | ------------- | -------------
[**activatePhoneNumber**](DeploymentApi.md#activatePhoneNumber) | **POST** /v1.1/apps/{appId}/deployments/{deploymentId}/activate | 
[**confirmCode**](DeploymentApi.md#confirmCode) | **POST** /v1.1/apps/{appId}/deployments/{deploymentId}/code/confirm | 
[**createDeployment**](DeploymentApi.md#createDeployment) | **POST** /v1.1/whatsapp/deployments | 
[**deleteDeployment**](DeploymentApi.md#deleteDeployment) | **DELETE** /v1.1/apps/{appId}/deployments/{deploymentId} | 
[**getDeployment**](DeploymentApi.md#getDeployment) | **GET** /v1.1/apps/{appId}/deployments/{deploymentId} | 
